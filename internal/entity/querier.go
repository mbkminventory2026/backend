...
type Querier interface {
	...
	CreateWorkOrderShell(ctx context.Context, arg CreateWorkOrderShellParams) (CreateWorkOrderShellRow, error)
	CreateWorkOrderShellSize(ctx context.Context, arg CreateWorkOrderShellSizeParams) (WorkOrderShellSize, error)
	CreateWorkOrderTrim(ctx context.Context, arg CreateWorkOrderTrimParams) (CreateWorkOrderTrimRow, error)
	...
	ListWorkOrderShellsByWorkOrderID(ctx context.Context, idWo int32) ([]ListWorkOrderShellsByWorkOrderIDRow, error)
	ListWorkOrderTrimsByWorkOrderID(ctx context.Context, idWo int32) ([]ListWorkOrderTrimsByWorkOrderIDRow, error)
