...
type Querier interface {
	...
	CreateProfilePerusahaan(ctx context.Context, arg CreateProfilePerusahaanParams) (ProfilePerusahaan, error)
	...
	DeleteProfilePerusahaan(ctx context.Context, idProfilePerusahaan int32) (int64, error)
	...
	GetProfilePerusahaan(ctx context.Context) (ProfilePerusahaan, error)
	GetProfilePerusahaanByID(ctx context.Context, idProfilePerusahaan int32) (ProfilePerusahaan, error)
	...
	UpdateProfilePerusahaan(ctx context.Context, arg UpdateProfilePerusahaanParams) (ProfilePerusahaan, error)
