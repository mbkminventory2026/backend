...
type Querier interface {
	...
	CountSizes(ctx context.Context, searchTerm string) (int64, error)
	...
	CreateDataApproveCuttingPlan(ctx context.Context, arg CreateDataApproveCuttingPlanParams) (DataApproveCuttingPlan, error)
	...
	CreateReceivedSimple(ctx context.Context, arg CreateReceivedSimpleParams) (CreateReceivedSimpleRow, error)
	CreateRekonsiliasi(ctx context.Context, arg CreateRekonsiliasiParams) (Rekonsiliasi, error)
	CreateRekonsiliasiMaterialRow(ctx context.Context, arg CreateRekonsiliasiMaterialRowParams) (RekonsiliasiMaterialRow, error)
	CreateRekonsiliasiTerimaEntry(ctx context.Context, arg CreateRekonsiliasiTerimaEntryParams) (RekonsiliasiTerimaEntry, error)
	...
	CreateWorkOrderShellSize(ctx context.Context, arg CreateWorkOrderShellSizeParams) (CreateWorkOrderShellSizeRow, error)
	...
	DeleteReceivedSimple(ctx context.Context, idReceived int32) error
	DeleteRekonsiliasiMaterialRowsByRekonsiliasiID(ctx context.Context, idRekonsiliasi int32) error
	DeleteRekonsiliasiTerimaEntriesByRowID(ctx context.Context, idRekonsiliasiMaterialRow int32) error
	...
	GetAdminSistemActiveWorkOrdersCount(ctx context.Context) (int64, error)
	GetAdminSistemOngoingWorkOrders(ctx context.Context) ([]GetAdminSistemOngoingWorkOrdersRow, error)
	GetAdminSistemOutputHariIni(ctx context.Context) (int32, error)
	GetAdminSistemTargetProduksiHariIni(ctx context.Context) (int32, error)
	...
	GetDataApproveCuttingPlanByID(ctx context.Context, idDacp int32) (GetDataApproveCuttingPlanByIDRow, error)
	GetDataApproveCuttingPlanRows(ctx context.Context, idWo int32) ([]GetDataApproveCuttingPlanRowsRow, error)
	...
	GetReceivedByID(ctx context.Context, idReceived int32) (GetReceivedByIDRow, error)
	GetReceivedQtyByWOShellID(ctx context.Context, idWoShell pgtype.Int4) (int64, error)
	GetRekonsiliasiByID(ctx context.Context, idRekonsiliasi int32) (GetRekonsiliasiByIDRow, error)
	GetRekonsiliasiByWOID(ctx context.Context, idWo int32) (Rekonsiliasi, error)
	GetRekonsiliasiMaterialStock(ctx context.Context, idRekonsiliasiMaterial int32) (GetRekonsiliasiMaterialStockRow, error)
	GetRekonsiliasiSourceHeader(ctx context.Context, idWo int32) (GetRekonsiliasiSourceHeaderRow, error)
	...
	ListMaterialListExportCutting(ctx context.Context, idWo int32) ([]ListMaterialListExportCuttingRow, error)
	ListMaterialListExportItems(ctx context.Context, idMaterialList int32) ([]ListMaterialListExportItemsRow, error)
	ListMaterialListExportMarkerPlans(ctx context.Context, idWo int32) ([]ListMaterialListExportMarkerPlansRow, error)
	ListMaterialListExportMarkerRatios(ctx context.Context, idWo int32) ([]ListMaterialListExportMarkerRatiosRow, error)
	ListMaterialListExportReceivedByDate(ctx context.Context, idMaterialList int32) ([]ListMaterialListExportReceivedByDateRow, error)
	ListMaterialListExportReconciliationRows(ctx context.Context, arg ListMaterialListExportReconciliationRowsParams) ([]ListMaterialListExportReconciliationRowsRow, error)
	ListMaterialListExportShellSizes(ctx context.Context, idWo int32) ([]ListMaterialListExportShellSizesRow, error)
	ListMaterialListExportSuratJalanByDate(ctx context.Context, idMaterialList int32) ([]ListMaterialListExportSuratJalanByDateRow, error)
	...
	ListReceived(ctx context.Context, arg ListReceivedParams) ([]ListReceivedRow, error)
	ListReceivedByMLI(ctx context.Context, idMaterialListItem int32) ([]ListReceivedByMLIRow, error)
	ListRekonsiliasiColorSourcesByWO(ctx context.Context, idWo int32) ([]ListRekonsiliasiColorSourcesByWORow, error)
	ListRekonsiliasiMaterialRowsByRekonsiliasiID(ctx context.Context, idRekonsiliasi int32) ([]RekonsiliasiMaterialRow, error)
	ListRekonsiliasiMaterialSourceRowsByWO(ctx context.Context, idWo int32) ([]ListRekonsiliasiMaterialSourceRowsByWORow, error)
	ListRekonsiliasiShellSourcesByWO(ctx context.Context, idWo int32) ([]ListRekonsiliasiShellSourcesByWORow, error)
	ListRekonsiliasiTerimaEntriesByRekonsiliasiID(ctx context.Context, idRekonsiliasi int32) ([]RekonsiliasiTerimaEntry, error)
	ListRekonsiliasis(ctx context.Context, arg ListRekonsiliasisParams) ([]ListRekonsiliasisRow, error)
	...
	ListWorkOrderShellSizesByWorkOrderID(ctx context.Context, idWo int32) ([]ListWorkOrderShellSizesByWorkOrderIDRow, error)
	...
	MaterialListHasApplicabilityShell(ctx context.Context, arg MaterialListHasApplicabilityShellParams) (bool, error)
	MaterialListHasApplicabilityShellSize(ctx context.Context, arg MaterialListHasApplicabilityShellSizeParams) (bool, error)
	MaterialListHasApplicabilitySize(ctx context.Context, arg MaterialListHasApplicabilitySizeParams) (bool, error)
	MaterialListHasSourceShell(ctx context.Context, arg MaterialListHasSourceShellParams) (bool, error)
	MaterialListHasSourceTrim(ctx context.Context, arg MaterialListHasSourceTrimParams) (bool, error)
	...
	UpdateReceivedSimple(ctx context.Context, arg UpdateReceivedSimpleParams) (UpdateReceivedSimpleRow, error)
	UpdateRekonsiliasiMaterialRowManualFields(ctx context.Context, arg UpdateRekonsiliasiMaterialRowManualFieldsParams) (RekonsiliasiMaterialRow, error)
	UpdateRekonsiliasiSnapshot(ctx context.Context, arg UpdateRekonsiliasiSnapshotParams) (Rekonsiliasi, error)
	UpdateRole(ctx context.Context, arg UpdateRoleParams) (Role, error)
	UpdateSize(ctx context.Context, arg UpdateSizeParams) (MasterSize, error)
