...
type Querier interface {
	...
	CreatePackingListRejectSize(ctx context.Context, arg CreatePackingListRejectSizeParams) (PackingListRejectSize, error)
	...
	ListPackingListRejectSizesByPackingListID(ctx context.Context, idPackingList int32) ([]PackingListRejectSize, error)
