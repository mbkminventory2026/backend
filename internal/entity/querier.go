...
type Querier interface {
	...
	CreatePOClient(ctx context.Context, arg CreatePOClientParams) (CreatePOClientRow, error)
	...
	ListPaymentTerms(ctx context.Context) ([]ListPaymentTermsRow, error)
	...
	UpdatePOClient(ctx context.Context, arg UpdatePOClientParams) (UpdatePOClientRow, error)
