...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/material-lists/{id}/export/excel": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/material-lists/{id}/import/excel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "XLSX import workbook",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/api/v1/material-lists/{id}/import/excel/template": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/packing-lists/{id}/export/excel": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/po-internals/{id}/export/excel": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/pr-internals/{id}/export/excel": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.BackupListSuccessDoc"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/model.BackupStartSuccessDoc"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.BackupStatusSuccessDoc"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/v1/system/backups/{backup_id}/download": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Server-generated backup ID",
                        "name": "backup_id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/v1/work-orders/{id}/export/excel": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "model.BackupListResponse": {
            ...
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.BackupSummary"
                    }
                },
                "pagination": {
                    "$ref": "#/definitions/model.PaginationMeta"
        ...
        "model.BackupListSuccessDoc": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "backup history retrieved"
                },
                "status": {
                    "type": "string",
                    "example": "success"
        ...
        "model.BackupStartSuccessDoc": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/model.BackupStartResponse"
                },
                "message": {
                    "type": "string",
                    "example": "backup accepted"
                },
                "status": {
                    "type": "string",
                    "example": "success"
        ...
        "model.BackupStatusResponse": {
            ...
            "properties": {
                ...
                "last_result": {
                    "$ref": "#/definitions/model.BackupLastResult"
                },
        ...
        "model.BackupStatusSuccessDoc": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/model.BackupStatusResponse"
                },
                "message": {
                    "type": "string",
                    "example": "backup status retrieved"
                },
                "status": {
                    "type": "string",
                    "example": "success"
